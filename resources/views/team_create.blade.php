...
<form @class(['space-y-4']) method="POST" action="{{route('teams.store')}}">
    ...
    <div @class(['flex', 'flex-col' ])>
        ...
        <input type="text" id="team_name" class="border border-gray-300 rounded-md px-3 py-2 text-gray-900
                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
            name="team_name">
    </div>

    <button type="submit" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-black text-sm font-medium
